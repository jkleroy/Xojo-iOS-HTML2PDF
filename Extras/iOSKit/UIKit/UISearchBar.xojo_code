	...
	#tag Method, Flags = &h21
		Private Shared Function TargetClass() As Ptr
		  ...
		  if targetID = Nil then
		    ...
		    methods.Add new TargetClassMethodHelper("searchBar:textDidChange:", AddressOf impl_TextChanged, "v@:@@")
		    'methods.Add new TargetClassMethodHelper("searchBar:shouldChangeTextInRange:replacementText:", AddressOf impl_shouldReplaceText, "b@:@:{NSRange=LL}@")
		    methods.Add new TargetClassMethodHelper("searchBarBookmarkButtonClicked:", AddressOf impl_bookmarkButtonPressed, "v@:@")
		    methods.Add new TargetClassMethodHelper("searchBarCancelButtonClicked:", AddressOf impl_cancelButtonPressed, "v@:@")
		    methods.Add new TargetClassMethodHelper("searchBarSearchButtonClicked:", AddressOf impl_searchButtonPressed, "v@:@")
		    methods.Add new TargetClassMethodHelper("searchBarResultsListButtonClicked:", AddressOf impl_resultListButtonPressed, "v@:@")
		    methods.Add new TargetClassMethodHelper("searchBar:selectedScopeButtonIndexDidChange:", AddressOf impl_scopeButtonChanged, "v@:@i")
		    methods.Add new TargetClassMethodHelper("searchBarTextDidBeginEditing:", AddressOf impl_didBeginEditing, "v@:@")
