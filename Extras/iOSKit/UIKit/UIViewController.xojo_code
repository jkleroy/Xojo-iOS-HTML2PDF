...
Inherits UIResponder
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Return new UIPopoverPresentationController(popoverPresentationController_(self))
			End Get
		#tag EndGetter
		popoverPresentationController As UIPopoverPresentationController
	#tag EndComputedProperty
	...
	#tag Enum, Name = UIModalPresentationStyle, Type = Integer, Flags = &h0
		fullscreen = 0
		  pageSheet
		  formSheet
		  currentContext
