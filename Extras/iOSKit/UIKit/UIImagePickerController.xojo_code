	...
	#tag Method, Flags = &h21
		Private Shared Function TargetClass() As Ptr
		  ...
		  if targetID = Nil then
		    ...
		    methods.Add new TargetClassMethodHelper("imagePickerController:didFinishPickingMediaWithInfo:", AddressOf impl_didFinishPickingMedia, "v@:@@")
		    methods.Add new TargetClassMethodHelper("imagePickerControllerDidCancel:", AddressOf impl_didCancel, "v@:@")
