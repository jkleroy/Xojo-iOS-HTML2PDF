...
Inherits NSObject
	...
	#tag Method, Flags = &h0
		Sub SetStringForKey(value as String, defaultName as CFStringRef)
		  
		  If value.isEmpty Then
		    Dim err As New RuntimeException
		    err.Reason = CurrentMethodName + " value is empty"
		    Dim tmp As Text = defaultName
		    'jly_Crashcontroller.sharedInstance.setCustomData("defaultName", tmp)
