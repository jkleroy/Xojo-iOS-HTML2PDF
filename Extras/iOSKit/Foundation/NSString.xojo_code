...
Inherits NSObject
	...
	#tag Method, Flags = &h1000
		Shared Function AvailableStringEncodings() As NSStringEncoding()
		  ...
		  dim m As Xojo.Core.MemoryBlock = new Xojo.Core.MemoryBlock(availableStringEncodings(ClassRef))
		  
		  dim offset as UInt32 = 0
		  while m.UInt32Value(offset) <> 0
		    rb_array.Add CType(m.UInt32Value(offset), NSStringEncoding)
	...
	#tag Method, Flags = &h0
		Function EscapedURL(anEncoding as NSStringEncoding = NSStringEncoding.NSUTF8StringEncoding) As Text
		  ...
		  'declare Function stringByAddingPercentEncodingWithAllowedCharacters lib FoundationLib selector "stringByAddingPercentEncodingWithAllowedCharacters:" _
		  '(obj_id as ptr, allowedCharacters as ptr) as CFStringRef
		  '
		  'dim charset As Foundation.NSCharacterSet = Foundation.NSCharacterSet.init(":/?&=;+!@#$()',*")
		  '
		  'Return stringByAddingPercentEncodingWithAllowedCharacters( self, charset)
		End Function
	#tag EndMethod
