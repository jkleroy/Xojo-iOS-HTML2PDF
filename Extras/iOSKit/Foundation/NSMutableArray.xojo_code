...
Inherits NSArray
	...
	#tag Method, Flags = &h0
		Shared Function CreateWithStringArray(values() As Text) As NSMutableArray
		  ...
		  Dim arrayRef As ptr = arrayWithCapacity(ClassRef, values.Count)
		  
		  For i As Integer = 0 To Values.LastIndex
		    addObject(arrayRef, values(i))
		  Next
